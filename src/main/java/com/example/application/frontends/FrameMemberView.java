...
public class FrameMemberView extends VerticalLayout {
    ...
    private void configureForm (MyUI UI) {
        ...
        InputFrame.trim(BCx, 2);
        InputFrame.trim(BCy, 2);
        InputFrame.trim(Px, 2);
        InputFrame.trim(Py, 2);
    ...
    private VerticalLayout configureEditForm (FrameMember FM, MyUI UI) {
        ...
        InputFrame.trim(BCx_e, 2);
        InputFrame.trim(BCy_e, 2);
        InputFrame.trim(Px_e, 2);
        InputFrame.trim(Py_e, 2);
