...
public class GraphStyle {
    ...
    public String frameMemberLineColor = "#000000";
    ...
    public String frameMemberDashedLineColor = "#808080";
    public PointSymbolType frameMemberDashedLinePointSymbolType = PointSymbolType.NONE;
    ...
    public LineStyle.Type jointLineStyleType = LineStyle.Type.SOLID;
    ...
    public String jointLoadLineColor = "#0000FF";
    ...
    public String pointLoadLineColor = "#0000FF";
    ...
    public String linearlyDistributedLoadLineColor = "#0000FF";
    ...
    public String normalLineColor = "#FFC0CB";
    public String shearLineColor = "#964B00";
    public String momentLineColor = "#A020F0";
    public PointSymbolType internalForcePointSymbolType = PointSymbolType.NONE;
    ...
    public String displacementLineColor = "#ADD8E6";
    public PointSymbolType displacementPointSymbolType = PointSymbolType.NONE;
